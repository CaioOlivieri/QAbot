...
(_section_coverage, _section_ast_bugs, _section_dynamic_bugs,
_section_semantic_bugs, _section_suspected, _section_api, _compute_score).
Score = 40% cobertura + 40% bugs + 20% API
(bug_score = 100 - 10/crítico - 3/warning; api_score = % aprovados).
Bugs semânticos confirmados entram no bug_score; suspeitos ("For Review")
ficam FORA do score.
